          ...
          <TableBody>
            {rows.map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell align="right"><Button className={classes.rejectBtn} onClick={togglePopup} variant="contained" size = "small" color="secondary">Reject</Button></TableCell>
                {isOpen && <Popup
                  content={<>
                  <form> 
                      <TextField
                          ...
                          variant="filled"
                        />
                    <Button className={classes.rejectBtn2} onClick={togglePopup} variant="contained" size = "medium" color="secondary">Reject</Button>
                  </form>
                  </>}
